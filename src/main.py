        ...
        for batch in sly.batched(videos):
            for video_info in batch:
                ...
                if g.OPTIONS == "annotated":
                    ...
                    frames_timestamps = [video_timestamps[frame_number] for frame_number in frames_to_convert]
                ...
                for batch_index, (batch_frames, batch_timestamps) in enumerate(zip(
                    ...
                    for frame_index in batch_frames:
                        metas.append(
                            {"video_id": video_info.id, "video_name": video_info.name, "frame_index": frame_index,
                             "video_dataset_id": video_info.dataset_id, "video_dataset_name": dataset.name,
                             "video_project_id": g.project.id, "video_project_name": g.project.name})
